...
export const addUser = (email, password, firstName , lastName, address, phone_number, is_admin, is_manage) => async (dispatch, getState) => {
    dispatch(resetUser())
    let res
    try {
...
export const updateUser = (email, firstName, lastName, address, phone_number, is_admin, is_manage) => async (dispatch, getState) => {
    let res
    console.log('manage',is_manage);
